        ...
        <table class="table-hover" v-if="lectures">
          ...
          <tbody>
            ...
            >
              ...
              <th v-if="type=='professor'"><b-button v-if="type == 'professor'" type="button" name="button" @click="delete_lecture(item.lecture_id, item.index, 'canceled')">삭제</b-button><br></th>
              <!-- and so on -->
            </tr>
          </tbody>
        </table>
